...
async def to_code(config):
    ...
    cg.add_build_flag("-DILI9488_DRIVER=1")
    ...
    cg.add_build_flag("-DTFT_DC=15")
    cg.add_build_flag("-DTFT_RST=32")
    cg.add_build_flag("-DTFT_WR=4")
    cg.add_build_flag("-DTFT_RD=2")
    cg.add_build_flag("-DTFT_D0=12")
    cg.add_build_flag("-DTFT_D1=13")
    cg.add_build_flag("-DTFT_D2=26")
    cg.add_build_flag("-DTFT_D3=25")
    cg.add_build_flag("-DTFT_D4=17")
    cg.add_build_flag("-DTFT_D5=16")
    cg.add_build_flag("-DTFT_D6=27")
    cg.add_build_flag("-DTFT_D7=14")
